...
__all__ = [
    'DISPID_SRRSaveToMemory', 'DISPID_SVSRunningState', 'SPSHT_OTHER',
    'SVP_5', 'SP_VISEME_19', 'SVP_14', 'SpAudioFormat',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SVGetAudioOutputs',
    'DISPID_SRProfile', 'SPRULE',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SOTCDefault',
    'DISPID_SDKEnumValues', 'SPRST_ACTIVE_ALWAYS', 'SVSFlagsAsync',
    'SFTSREngine', 'SpeechGrammarTagDictation',
    'Speech_StreamPos_Asap', 'SPEI_RESERVED3', 'SPDATAKEYLOCATION',
    'SpeechTokenIdUserLexicon', 'SAFT22kHz16BitStereo',
    'ISpObjectWithToken', 'SPFM_CREATE',
    'ISpeechGrammarRuleStateTransition', 'ISpeechPhraseElements',
    'DISPID_SASFreeBufferSpace', 'SAFTADPCM_44kHzMono', 'SPAS_CLOSED',
    'SPEVENTSOURCEINFO', 'DISPID_SAFGuid', 'SPEI_MAX_SR', 'SASStop',
    'DISPID_SVEVoiceChange', 'SPSHT_NotOverriden',
    'DISPID_SGRSAddSpecialTransition',
    'DISPID_SRSNumberOfActiveRules', 'SpeechCategoryVoices', 'SVP_6',
    'SINoSignal', 'IEnumString', 'ISpeechPhraseRules',
    'SAFT22kHz8BitMono', 'SAFTCCITT_uLaw_8kHzStereo',
    'SpeechAllElements', 'SVSFNLPMask', 'SPPHRASEELEMENT',
    'DISPID_SVSPhonemeId', 'DISPID_SLPsCount',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'DISPID_SABufferNotifySize', '_ISpeechVoiceEvents',
    'SpSharedRecoContext', 'SPWT_LEXICAL',
    'DISPID_SVSyncronousSpeakTimeout', 'SpeechWordType',
    'ISpeechRecoResultDispatch', 'DISPID_SpeechLexiconWords',
    'ISpProperties', 'SPBO_NONE', 'SPEI_RECO_STATE_CHANGE',
    'DISPID_SpeechWaveFormatEx', 'SPDKL_DefaultLocation',
    'SPSSuppressWord', 'DISPID_SVSVisemeId', 'DISPID_SPRText',
    ...
    'DISPID_SpeechMMSysAudio', 'DISPIDSPTSI_ActiveLength',
    'ISpeechRecognizer', 'DISPID_SREmulateRecognition',
    'SPINTERFERENCE_TOOSLOW', 'SBOPause', 'SpPhraseInfoBuilder',
    'SpeechRetainedAudioOptions', 'SDA_Consume_Leading_Spaces',
    'SPEI_START_SR_STREAM', 'SPEI_SOUND_START', 'SAFTGSM610_8kHzMono',
    'SRERecognition', 'ISpeechGrammarRule', 'SSFMCreateForWrite',
    'DISPID_SPIProperties', 'SPBO_TIME_UNITS', 'DISPID_SPPsItem',
    'DISPID_SPRuleName', 'SpeechTokenKeyAttributes',
    'DISPID_SRCRecognizer', 'DISPID_SpeechRecoContext',
    'SpeechPropertyResourceUsage', 'DISPID_SADefaultFormat',
    'SPEI_PROPERTY_STRING_CHANGE', 'SRTExtendableParse',
    'DISPID_SPEDisplayText', 'DISPID_SLGetWords',
    'DISPID_SVSpeakStream', 'DISPID_SPRuleNumberOfElements',
    'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SRIsShared',
    'SAFTTrueSpeech_8kHz1BitMono', 'SRESoundStart', 'SP_VISEME_12',
    'DISPID_SDKSetBinaryValue', 'SPEI_VISEME',
    'DISPID_SpeechXMLRecoResult', 'DISPID_SpeechGrammarRules',
    'SVEAudioLevel', 'SRESoundEnd', 'SPEVENT',
    'SpeechPropertyComplexResponseSpeed', 'SVP_9',
    'SpeechGrammarRuleStateTransitionType', 'DISPIDSPTSI',
    'DISPID_SPAs_NewEnum', 'SPRS_INACTIVE',
    'DISPID_SRSetPropertyString', 'DISPID_SRCRetainedAudio',
    'DISPID_SPIGrammarId', 'eLEXTYPE_PRIVATE16', 'SPAR_Unknown',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SRCEBookmark',
    'DISPID_SPPEngineConfidence', 'DISPID_SVSpeak',
    'SpeechTokenValueCLSID', 'DISPID_SRGReset', 'SpeechTokenContext',
    'SpLexicon', 'SPFM_CREATE_ALWAYS', 'eLEXTYPE_PRIVATE17',
    'ISpeechObjectToken', 'DISPID_SRRTTickCount', 'SPAR_Medium',
    'DISPID_SCSBaseStream', 'SFTInput', 'SPSHORTCUTTYPE',
    'eLEXTYPE_PRIVATE14', 'DISPID_SVEventInterests',
    'ISpeechGrammarRules', 'DISPID_SLAddPronunciation',
    'DISPID_SFSOpen', 'DISPID_SRCResume', 'DISPID_SPRuleId',
    'SECLowConfidence', 'DISPID_SRCPause',
    'DISPID_SpeechObjectTokens', 'SP_VISEME_0',
    'DISPID_SpeechBaseStream', 'ISpRecoCategory', 'eLEXTYPE_PRIVATE9',
    'DISPID_SVAlertBoundary', 'DISPID_SLGetGenerationChange',
    'DISPID_SFSClose', 'DISPID_SpeechRecoContextEvents',
    'DISPID_SGRSTPropertyId', 'DISPID_SGRSTWeight',
    'SpeechUserTraining', 'DISPID_SLPType', 'SPBO_PAUSE',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SOTIsUISupported',
    'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SRRecognizer',
    'ISpeechDataKey', 'IEnumSpObjectTokens', 'SRTReSent',
    'SPPS_Noncontent', 'SAFTExtendedAudioFormat', 'SRAInterpreter',
    'SRSInactiveWithPurge', 'SPXRO_Alternates_SML',
    'DISPID_SPEsCount', 'DISPID_SGRSTPropertyName',
    'DISPID_SPEDisplayAttributes', 'SPSHT_EMAIL', 'SPPS_Unknown',
    'SPEI_RESERVED1', 'SPWORD', 'SPDKL_CurrentUser', 'SP_VISEME_8',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SITooLoud',
    'DISPID_SPERetainedStreamOffset', 'SPEI_TTS_PRIVATE',
    'DISPID_SVIsUISupported', 'DISPID_SVSLastBookmark',
    'SVSFIsNotXML', 'DISPID_SRCERecognizerStateChange',
    'SAFTCCITT_ALaw_22kHzMono', 'ISpeechAudioFormat',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SGRSTTRule',
    'DISPID_SGRAddResource', 'DISPID_SGRSTNextState', 'SREAdaptation',
    'SECFEmulateResult', 'SAFT11kHz16BitStereo',
    'DISPID_SOTMatchesAttributes', 'SLOStatic', 'SVESentenceBoundary',
    'SPAUDIOSTATE', 'SpUnCompressedLexicon', 'SpeechEngineProperties',
    'SpFileStream', 'DISPID_SRCESoundEnd',
    '_ISpeechRecoContextEvents', 'SINone', 'SPEI_UNDEFINED',
    'DISPID_SPIEngineId', 'DISPID_SWFEFormatTag', 'SpeechAudioState',
    'ISpeechLexiconPronunciations', 'SASPause', 'SLODynamic',
    'DISPID_SLGenerationId', 'SPINTERFERENCE_NOSIGNAL',
    'SpeechTokenKeyUI', 'DISPID_SRCEAdaptation', 'ISpStream',
    'SpeechTokenShellFolder', 'DISPID_SLWType', 'DISPID_SPRulesCount',
    'SpMMAudioEnum', 'SREPropertyNumChange',
    'DISPID_SVSLastBookmarkId',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SpeechRecognizerState',
    'SpNotifyTranslator', 'DISPID_SPIStartTime', 'SVP_7',
    'ISpeechPhoneConverter', 'SWPUnknownWordPronounceable',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SLPLangId',
    'DISPID_SRCBookmark', 'DISPID_SOTCGetDataKey',
    'ISpeechObjectTokenCategory',
    'SpeechGrammarTagUnlimitedDictation',
    'DISPID_SpeechPhraseReplacements', 'SpeechPropertyResponseSpeed',
    'SAFT16kHz8BitStereo', 'SAFTGSM610_44kHzMono', 'SVSFParseSsml',
    'DISPID_SBSWrite', 'SVP_8', 'DISPID_SGRSTText',
    'SPRS_ACTIVE_USER_DELIMITED', 'DISPID_SRCreateRecoContext',
    'DISPID_SPEAudioSizeBytes', 'SAFT12kHz16BitStereo',
    'SAFTCCITT_ALaw_44kHzStereo',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'DISPID_SpeechAudio',
    'DISPID_SRGSetTextSelection', 'SPPS_Noun', 'SVEViseme',
    'DISPID_SAVolume', 'SAFTCCITT_uLaw_44kHzStereo',
    'SPAUDIOBUFFERINFO', 'DISPID_SPPConfidence',
    'IInternetSecurityManager', 'DISPID_SGRSTType', 'SPSVerb',
    'SGSDisabled', 'SpeechGrammarTagWildcard', 'SRARoot',
    'SAFTADPCM_44kHzStereo', 'DISPID_SGRsCommitAndSave',
    'SpeechAudioVolume', 'SpeechStreamFileMode', 'SAFT44kHz16BitMono',
    'ISpEventSource', 'DISPID_SVEStreamEnd', 'DISPID_SPACommit',
    'DISPID_SpeechRecognizer', 'DISPID_SWFEExtraData',
    'SpeechMicTraining', 'SpeechAudioFormatType',
    'DISPID_SpeechPhraseReplacement', 'SPEI_SENTENCE_BOUNDARY',
    'SpeechRecognitionType', 'eLEXTYPE_RESERVED9',
    'DISPID_SGRSTsItem', 'DISPID_SGRSTPropertyValue',
    'DISPID_SRCRetainedAudioFormat', 'SPPARTOFSPEECH',
    'DISPID_SGRSTRule', 'UINT_PTR', 'SVP_17', 'ISpNotifySink',
    'DISPID_SpeechVoice', 'SASRun', 'DISPID_SRIsUISupported',
    'DISPID_SVWaitUntilDone', 'ISpeechAudio', 'SPRULESTATE',
    'DISPID_SGRClear', 'DISPID_SRCERecognitionForOtherContext',
    'SPDKL_LocalMachine', 'DISPID_SRGCmdLoadFromResource', 'SWTAdded',
    'DISPID_SDKCreateKey', 'eLEXTYPE_RESERVED8', 'SITooSlow',
    'SPEI_RECOGNITION', 'ISpeechAudioStatus', 'SAFT24kHz16BitMono',
    'SAFTADPCM_22kHzMono', 'ISpSerializeState', 'ISpeechLexiconWord',
    'SDKLCurrentConfig', 'DISPID_SPIReplacements', 'DISPID_SRStatus',
    'DISPID_SRSetPropertyNumber', 'DISPID_SLPPhoneIds',
    'SAFT24kHz8BitStereo', 'DISPID_SVPause', 'DISPID_SPRsItem',
    'SAFTNoAssignedFormat', 'SpObjectTokenCategory',
    'DISPID_SPCIdToPhone', 'SPRS_ACTIVE',
    'DISPID_SpeechPhraseBuilder', 'DISPID_SPAStartElementInResult',
    'SSFMOpenForRead', '_SPAUDIOSTATE', 'ISpeechRecoResultTimes',
    'DISPID_SPEEngineConfidence', 'SECFIgnoreWidth',
    'DISPID_SRCEAudioLevel', 'SGDSActiveWithAutoPause',
    'STSF_AppData', 'SECNormalConfidence', 'SREStreamStart',
    'SpResourceManager', 'SPCS_ENABLED', 'DISPID_SVSLastResult',
    'SpeechPropertyAdaptationOn', 'SpPhoneConverter',
    'SpeechCategoryPhoneConverters', 'DISPID_SRGCommit', 'SPAO_NONE',
    'SpeechDiscardType', 'SPFILEMODE', 'SpeechRegistryUserRoot',
    'DISPID_SPEs_NewEnum', 'SpeechInterference', 'SP_VISEME_21',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SRGDictationUnload',
    'SGRSTTWord', 'SpStream', 'SpeechGrammarState', 'SVP_4',
    'DISPID_SVEWord', 'eLEXTYPE_USER', 'SPSHT_Unknown',
    'SPSInterjection', 'eLEXTYPE_PRIVATE12', 'DISPID_SVPriority',
    'eWORDTYPE_DELETED', 'SPLO_STATIC', 'DISPID_SLPSymbolic',
    'SpWaveFormatEx', 'SAFT16kHz8BitMono', 'SpeechRuleAttributes',
    'eLEXTYPE_PRIVATE10', 'DISPID_SRRAudio', 'SPEI_RESERVED2',
    'DISPID_SpeechPhraseAlternate', 'DISPID_SPARecoResult',
    'SSTTTextBuffer', 'SAFT32kHz8BitStereo',
    'SAFTCCITT_ALaw_8kHzMono', 'SPEI_PROPERTY_NUM_CHANGE',
    'DISPID_SWFEChannels', 'eLEXTYPE_PRIVATE1', 'SAFT22kHz16BitMono',
    'SAFT44kHz8BitStereo', 'SGDSActiveUserDelimited',
    'DISPID_SpeechLexiconProns',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'DISPID_SRGRecoContext',
    'DISPID_SPPName', 'SSTTDictation', 'DISPID_SGRsFindRule',
    'SRSEIsSpeaking', 'SGLexical', 'STSF_FlagCreate', 'SVP_21',
    'SpMemoryStream', 'DISPID_SPPParent',
    'DISPID_SPANumberOfElementsInResult',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SVGetVoices',
    'DISPID_SRGCmdSetRuleIdState', 'DISPID_SPPs_NewEnum',
    'SPTEXTSELECTIONINFO', 'SPINTERFERENCE_NONE', 'SVP_0',
    'ISpeechRecoContext', 'DISPID_SVSInputSentencePosition',
    'SINoise', 'SPPS_Interjection', 'DISPID_SOTDataKey', 'SVP_15',
    'DISPID_SpeechObjectToken', 'SAFTCCITT_uLaw_22kHzMono',
    'DISPID_SGRsCount', 'SPSNoun', 'DISPID_SRCCmdMaxAlternates',
    'SPSHORTCUTPAIR', 'SPFM_OPEN_READONLY',
    'DISPID_SGRSAddWordTransition', 'SpeechDictationTopicSpelling',
    'DISPID_SBSRead', 'SGDSInactive', 'ISpeechPhraseRule',
    'SRSActive', 'SAFTCCITT_ALaw_11kHzStereo', 'SPDKL_CurrentConfig',
    'SVP_11', 'DISPID_SGRName', 'DISPID_SOTCreateInstance',
    'SPRST_NUM_STATES', 'SpVoice', 'DISPID_SASState', 'SPCT_COMMAND',
    'SPPS_RESERVED3', 'SRTSMLTimeout', 'ISequentialStream',
    'SSSPTRelativeToStart', 'DISPID_SVESentenceBoundary',
    'SPAUDIOSTATUS', 'SpPhoneticAlphabetConverter',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'ISpNotifySource', 'DISPID_SLRemovePronunciation', 'SP_VISEME_2',
    'DISPID_SRGRules', 'DISPID_SDKGetBinaryValue',
    'ISpeechWaveFormatEx', 'SpeechTokenKeyFiles',
    'SPSERIALIZEDRESULT', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'DISPID_SpeechFileStream', 'DISPID_SPPNumberOfElements',
    'DISPID_SRRTLength', 'SVSFDefault', 'SAFT24kHz8BitMono',
    'eLEXTYPE_VENDORLEXICON', 'STCLocalServer', 'SP_VISEME_9',
    'DISPID_SVEAudioLevel', 'DISPID_SGRAddState',
    'SpeechBookmarkOptions', 'SDTProperty', 'ISpRecoResult',
    'DISPID_SLGetPronunciations', 'DISPID_SLWs_NewEnum',
    'DISPID_SOTRemoveStorageFileName', 'SAFT44kHz8BitMono',
    'DISPID_SLWPronunciations', 'DISPID_SpeechMemoryStream',
    'ISpeechAudioBufferInfo', 'ISpeechVoiceStatus',
    'DISPID_SDKOpenKey', 'SpeechEngineConfidence', 'DISPID_SRCState',
    'SPCS_DISABLED', 'SSFMOpenReadWrite', 'SDTPronunciation',
    'SpeechDataKeyLocation', 'SP_VISEME_10', 'DISPID_SDKSetLongValue',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SPSHORTCUTPAIRLIST',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SRCEPropertyStringChange', 'SVSFPurgeBeforeSpeak',
    'SECFIgnoreCase', 'eLEXTYPE_RESERVED6', 'SPBOOKMARKOPTIONS',
    'SPADAPTATIONRELEVANCE', 'ISpRecognizer', 'SpNullPhoneConverter',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SP_VISEME_15', 'SPVPRI_ALERT',
    'DISPID_SpeechRecoResult2', 'DISPID_SPRuleConfidence',
    'SP_VISEME_11', 'DISPID_SMSSetData',
    'DISPID_SpeechPhraseProperty', 'DISPID_SRRPhraseInfo',
    'SWPKnownWordPronounceable', 'eLEXTYPE_PRIVATE19',
    'SPSMF_SAPI_PROPERTIES', 'DISPID_SDKGetlongValue',
    'SAFTADPCM_22kHzStereo', 'DISPID_SGRSTransitions',
    'SPFM_NUM_MODES', 'SPSNotOverriden', 'DISPID_SPIRule',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SRCEFalseRecognition',
    'DISPID_SPIAudioSizeTime', 'SAFT48kHz16BitStereo',
    'DISPID_SGRSTsCount', 'DISPID_SRSCurrentStreamNumber',
    'SpCustomStream', 'ISpAudio', 'ISpeechVoice',
    'ISpeechXMLRecoResult', 'SPVOICESTATUS', 'SRAORetainAudio',
    'DISPID_SPRs_NewEnum', 'SAFT48kHz8BitStereo',
    'DISPID_SLPs_NewEnum', 'SP_VISEME_5', 'SpeechWordPronounceable',
    'DISPID_SpeechGrammarRuleStateTransition', 'SPGS_EXCLUSIVE',
    'SVEEndInputStream', 'eLEXTYPE_USER_SHORTCUT',
    'STSF_CommonAppData', 'ISpeechGrammarRuleState', 'SPCATEGORYTYPE',
    'SDTAudio', 'DISPID_SRRTOffsetFromStart', 'SPINTERFERENCE_NOISE',
    'DISPID_SPRsCount', 'ISpeechRecoResult2',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SGRSTs_NewEnum',
    'SGRSTTWildcard', 'SREPrivate', 'SPWF_INPUT', 'SPEI_MIN_SR',
    'SAFT12kHz8BitStereo', 'DISPID_SGRSRule', 'DISPID_SWFEBlockAlign',
    'SDA_Two_Trailing_Spaces', 'SITooFast', 'DISPID_SBSFormat',
    'DISPID_SRRTStreamTime', 'SRCS_Enabled', 'SP_VISEME_13',
    'SPPS_RESERVED2', 'SASClosed', 'DISPID_SMSAMMHandle',
    'SPPS_Function', 'SP_VISEME_1', 'SDKLLocalMachine', 'tagSTATSTG',
    'DISPID_SPEAudioTimeOffset', 'SAFTNonStandardFormat',
    'SpeechGrammarWordType', 'ISpeechRecoResult',
    'SAFT32kHz16BitMono', 'SPPS_NotOverriden',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SVEStreamStart',
    'SPRECOGNIZERSTATUS', 'SpObjectToken', 'SPWORDPRONUNCIATIONLIST',
    'ISpResourceManager', 'SPWT_PRONUNCIATION', 'ISpeechCustomStream',
    'SSFMCreate', 'DISPID_SPISaveToMemory', 'DISPID_SOTsCount',
    'LONG_PTR', 'SAFTADPCM_11kHzStereo', 'SP_VISEME_7', 'SRATopLevel',
    'DISPID_SRCERequestUI', 'DISPID_SGRs_NewEnum',
    'SAFT48kHz16BitMono', 'DISPID_SVGetAudioInputs',
    'DISPID_SMSADeviceId', 'SVF_Stressed',
    'DISPID_SpeechCustomStream', 'ISpPhrase',
    'ISpStreamFormatConverter', 'SAFT32kHz16BitStereo',
    'SpeechFormatType', 'DISPID_SVSCurrentStreamNumber',
    'DISPID_SpeechPhraseRule', 'DISPID_SABIEventBias',
    'SVSFNLPSpeakPunc', 'ISpeechPhraseInfo', 'STSF_LocalAppData',
    'SpeechVisemeFeature', 'DISPID_SpeechPhraseInfo', 'SPLEXICONTYPE',
    'DISPID_SRAudioInputStream', 'SpeechSpecialTransitionType',
    'SP_VISEME_17', 'DISPID_SVEEnginePrivate', 'SVEAllEvents',
    'eLEXTYPE_PRIVATE2', 'SVEPhoneme', 'SDTReplacement',
    'SRSInactive', 'eLEXTYPE_MORPHOLOGY', 'SP_VISEME_14',
    'SpeechEmulationCompareFlags', 'ISpeechPhraseAlternate',
    'SpeechPropertyNormalConfidenceThreshold', 'DISPIDSPRG',
    'SPWORDLIST', 'DISPID_SVAudioOutputStream', 'SP_VISEME_6',
    'DISPID_SPELexicalForm', 'SVSFUnusedFlags',
    'DISPID_SPRFirstElement', 'DISPID_SPRuleParent',
    'DISPID_SAFGetWaveFormatEx', 'SDKLCurrentUser', 'SVSFParseSapi',
    'DISPID_SRSAudioStatus', 'DISPID_SGRsCommit',
    'ISpeechPhraseAlternates', 'SpeechVoiceSpeakFlags',
    'DISPID_SASCurrentDevicePosition', 'SPEI_MAX_TTS', 'SDTRule',
    'SPEI_PHONEME', 'DISPID_SPPsCount', 'SREBookmark', 'SPPS_Verb',
    'SpeechRecoProfileProperties', 'DISPID_SOTsItem', 'SGRSTTEpsilon',
    'SPBINARYGRAMMAR', 'SPRST_INACTIVE', 'SPWORDPRONOUNCEABLE',
    'SPEI_END_SR_STREAM', 'DISPID_SDKGetStringValue',
    'ISpeechResourceLoader', 'SVF_None', 'DISPID_SRSClsidEngine',
    'DISPID_SPEAudioSizeTime', 'SPEI_SR_BOOKMARK', 'ISpRecoContext',
    'SPWORDPRONUNCIATION', 'SVSFParseAutodetect',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SAEventHandle',
    'ISpGrammarBuilder', 'ISpeechPhraseReplacement', 'SREPhraseStart',
    'SPGS_DISABLED', 'SDTAll', 'SVPOver', 'DISPID_SRCEInterference',
    'DISPID_SLWWord', 'SAFT22kHz8BitStereo',
    'DISPID_SPPBRestorePhraseFromMemory', 'SPAO_RETAIN_AUDIO',
    'DISPID_SASetState', 'ISpeechRecoGrammar', 'DISPID_SRGId',
    'DISPID_SRCEEndStream', 'ISpDataKey', 'SpeechAudioFormatGUIDText',
    'DISPID_SOTCEnumerateTokens', 'DISPID_SPPValue',
    'SREFalseRecognition', 'ISpeechRecognizerStatus',
    'SPINTERFERENCE_LATENCY_WARNING', 'ISpeechObjectTokens',
    'DISPID_SRCESoundStart', 'SAFTADPCM_11kHzMono',
    'DISPID_SRCEventInterests', 'SDKLDefaultLocation',
    'DISPID_SPERequiredConfidence', 'eLEXTYPE_PRIVATE6', 'SVP_19',
    'SPAR_High', 'SREPropertyStringChange', 'SREAudioLevel',
    'ISpShortcut', 'eLEXTYPE_PRIVATE11', 'DISPID_SVAudioOutput',
    'SRADefaultToActive', 'SECFDefault', 'SpeechVoiceEvents',
    'SVSFIsFilename', 'DISPID_SpeechRecognizerStatus',
    'SAFTADPCM_8kHzMono', '_RemotableHandle', 'STCRemoteServer',
    'DISPID_SPAPhraseInfo', 'DISPID_SLWLangId', 'SAFT12kHz16BitMono',
    'DISPID_SAFSetWaveFormatEx', 'DISPID_SGRAttributes',
    'DISPID_SLWsCount', 'DISPID_SRGetPropertyString',
    'SPEI_TTS_BOOKMARK', 'eLEXTYPE_LETTERTOSOUND', 'SPEI_SR_PRIVATE',
    'SPGRAMMARWORDTYPE', 'DISPID_SRCSetAdaptationData',
    'SPWT_DISPLAY', 'SDA_No_Trailing_Space', 'SRTEmulated',
    'SPXRO_SML', 'DISPID_SPPChildren', 'DISPID_SWFEBitsPerSample',
    'SPCT_DICTATION', 'SREStreamEnd', 'DISPID_SABIMinNotification',
    'DISPID_SPRulesItem', 'SVF_Emphasis', 'SPPS_LMA',
    'SPPHRASEREPLACEMENT', 'DISPID_SpeechPhraseProperties',
    'SGLexicalNoSpecialChars', 'SRTStandard', 'ISpeechPhraseProperty',
    'DISPID_SGRId', 'ISpObjectToken', 'eWORDTYPE_ADDED',
    'DISPID_SpeechVoiceEvent', 'SP_VISEME_4', 'SPEI_END_INPUT_STREAM',
    'DISPID_SOTId', 'DISPID_SpeechAudioBufferInfo',
    'DISPID_SpeechPhoneConverter', 'ISpeechLexiconPronunciation',
    'SP_VISEME_3', 'DISPID_SRGCmdSetRuleState',
    'DISPID_SpeechLexiconWord', 'DISPID_SPIAudioStreamPosition',
    'SpeechLoadOption', 'DISPID_SRSSupportedLanguages',
    'ISpRecoContext2', 'DISPID_SRCAudioInInterferenceStatus',
    'SPWAVEFORMATTYPE', 'SAFT8kHz16BitMono', 'DISPID_SVResume',
    'DISPID_SRGDictationSetState', 'SAFTCCITT_ALaw_11kHzMono',
    'SRSEDone', 'SAFTGSM610_22kHzMono', 'DISPID_SVDisplayUI',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SPLOADOPTIONS',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'ISpLexicon',
    'DISPID_SpeechPhraseElement', 'SpeechRegistryLocalMachineRoot',
    'ISpEventSink', 'SpeechRunState', 'ISpeechLexicon',
    'eLEXTYPE_RESERVED7', 'SVSFParseMask', 'ISpPhraseAlt',
    'DISPID_SpeechVoiceStatus', 'SAFTCCITT_ALaw_44kHzMono',
    'SpeechDisplayAttributes', 'SVEWordBoundary',
    'DISPID_SRCRequestedUIType', 'DISPID_SPCLangId',
    'SpStreamFormatConverter', 'SPVPRI_NORMAL', 'SPAS_PAUSE',
    'DISPID_SpeechRecoResult', 'DISPID_SRCCreateResultFromMemory',
    'SpeechVisemeType', 'SpeechPartOfSpeech',
    'SAFTCCITT_uLaw_11kHzStereo', 'SPSEMANTICFORMAT', 'SPPS_Modifier',
    'SPLO_DYNAMIC', 'SPEI_RESERVED5', 'SPRECOSTATE',
    'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SRGSetWordSequenceData',
    'DISPID_SRGIsPronounceable', 'DISPID_SASCurrentSeekPosition',
    'DISPID_SGRsItem', 'DISPID_SVSkip', 'SPINTERFERENCE_TOOLOUD',
    'STCAll', 'DISPID_SRAudioInput', 'DISPID_SRGetPropertyNumber',
    'SPPS_RESERVED1', 'SDTLexicalForm', 'SREStateChange',
    'Speech_Max_Pron_Length', 'SPEI_REQUEST_UI', 'SPEI_WORD_BOUNDARY',
    'DISPID_SRRTimes', 'SVP_18', 'SPEI_RESERVED6', 'SpeechRecoEvents',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'DISPID_SPRuleChildren',
    'DISPID_SLWsItem', 'SAFT8kHz16BitStereo',
    'DISPID_SRGDictationLoad', 'SGRSTTDictation', 'SPEVENTENUM',
    'SPWORDTYPE', 'SRAImport', 'SPSFunction', 'DISPID_SOTs_NewEnum',
    'SAFT11kHz16BitMono', 'DISPID_SPRNumberOfElements',
    'DISPID_SVSpeakCompleteEvent', 'SAFTCCITT_ALaw_8kHzStereo',
    'SPAR_Low', 'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SVSFIsXML',
    'SAFT16kHz16BitStereo', 'SPEI_SR_RETAINEDAUDIO',
    'SpeechPropertyHighConfidenceThreshold', 'DISPID_SRCVoice',
    'DISPID_SRCEHypothesis', 'ISpPhoneticAlphabetConverter',
    'SDA_One_Trailing_Space', 'DISPID_SVGetProfiles',
    'SpeechCategoryRecoProfiles', 'ISpXMLRecoResult',
    'DISPID_SLAddPronunciationByPhoneIds', 'Speech_Default_Weight',
    'SPSMF_UPS', 'SVP_2', 'SpeechVoiceCategoryTTSRate',
    'DISPID_SGRsAdd', 'ISpObjectTokenCategory',
    'DISPID_SPRules_NewEnum', 'SPVISEMES', 'DISPID_SRState',
    'DISPID_SRCEPropertyNumberChange', 'SRAONone', 'SPPS_RESERVED4',
    'SDTAlternates', 'eLEXTYPE_APP', 'Speech_Max_Word_Length',
    'SPSTREAMFORMATTYPE', 'DISPID_SRGCmdLoadFromMemory',
    'ISpPhoneConverter', 'SAFTCCITT_uLaw_11kHzMono', 'IStream',
    'DISPID_SABIBufferSize', 'ISpPhoneticAlphabetSelection',
    'SECHighConfidence', 'DISPID_SOTRemove', 'eLEXTYPE_PRIVATE13',
    'ISpeechPhraseElement', 'SVP_16', 'eLEXTYPE_PRIVATE7',
    'SREAllEvents', 'DISPID_SpeechDataKey', 'DISPID_SAFType',
    'DISPID_SRRGetXMLErrorInfo', 'DISPID_SRRAlternates',
    'tagSPPROPERTYINFO', 'DISPID_SPEPronunciation',
    'DISPID_SDKDeleteValue', 'ISpStreamFormat',
    'DISPID_SRRSpeakAudio', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SVPNormal', 'SpeechLexiconType', 'STCInprocServer',
    'DISPID_SRRAudioFormat', 'eLEXTYPE_PRIVATE5', 'SLTUser',
    'DISPID_SOTGetDescription', 'SPINTERFERENCE_TOOFAST',
    'SP_VISEME_20', 'SpeechPropertyLowConfidenceThreshold',
    'SAFT16kHz16BitMono', 'SVP_3', 'SRSActiveAlways',
    'SPEI_ADAPTATION', 'SPSERIALIZEDPHRASE',
    'ISpeechPhraseProperties', 'DISPID_SRDisplayUI',
    'SPSEMANTICERRORINFO', 'eLEXTYPE_RESERVED10', 'SPAS_RUN',
    'ISpeechLexiconWords', 'SAFT11kHz8BitMono', 'SPBO_AHEAD',
    'SPVPRI_OVER', 'SPSUnknown', 'DISPID_SPERetainedSizeBytes',
    'SVPAlert', 'SpCompressedLexicon', 'DISPID_SRCCreateGrammar',
    'DISPID_SRCERecognition', 'SPRST_ACTIVE', 'SPEI_SOUND_END',
    'ISpRecognizer2', 'eLEXTYPE_PRIVATE18',
    'DISPID_SRRSetTextFeedback', 'SAFT11kHz8BitStereo',
    'SSSPTRelativeToCurrentPosition', 'ISpeechPhraseInfoBuilder',
    'DISPID_SVVoice', 'SPPS_SuppressWord', 'DISPID_SPAsCount',
    'SpeechAudioFormatGUIDWave', 'eLEXTYPE_PRIVATE3',
    'eLEXTYPE_PRIVATE4', 'SECFIgnoreKanaType', 'SBONone',
    'DISPID_SOTCategory', 'DISPID_SBSSeek', 'SRERecoOtherContext',
    'SAFT12kHz8BitMono', 'SPEI_PHRASE_START', 'SAFTADPCM_8kHzStereo',
    'DISPID_SVEPhoneme', 'SAFTGSM610_11kHzMono',
    'DISPID_SpeechAudioFormat', 'SDTDisplayText',
    'SpeechRecoContextState', 'DISPIDSPTSI_SelectionOffset',
    'DISPID_SVVolume', 'SAFT8kHz8BitMono', 'DISPID_SABufferInfo',
    'SPSLMA', 'DISPID_SPAsItem', 'SpShortcut',
    'DISPID_SLPPartOfSpeech', 'WAVEFORMATEX', 'ISpMMSysAudio',
    'DISPID_SPIAudioSizeBytes', 'SpeechAddRemoveWord',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SRGetFormat',
    'Speech_StreamPos_RealTime', 'SVSFPersistXML',
    'DISPID_SPIEnginePrivateData', 'SVEPrivate', 'DISPID_SDKEnumKeys',
    'SPEI_START_INPUT_STREAM', 'SREHypothesis',
    'DISPID_SRRRecoContext', 'SRAExport', 'SVEBookmark',
    'SRTAutopause', 'SAFTDefault', 'SAFTText', 'SGRSTTTextBuffer',
    'DISPID_SpeechPhraseElements', 'SVP_1',
    'DISPID_SVSInputWordLength', 'ISpRecoGrammar', 'SGPronounciation',
    'DISPID_SOTGetStorageFileName', 'SRADynamic', 'SPEI_INTERFERENCE',
    'SPRECORESULTTIMES', '__MIDL_IWinTypes_0009', 'SGSEnabled',
    'eLEXTYPE_PRIVATE15', 'SpSharedRecognizer', 'ISpeechMMSysAudio',
    'eLEXTYPE_PRIVATE20', 'SGDisplay', 'DISPID_SRGState',
    'STCInprocHandler', 'DISPID_SVEViseme',
    'DISPID_SVSInputSentenceLength', 'SAFT32kHz8BitMono',
    'DISPID_SLPsItem', 'SpInprocRecognizer', 'SRCS_Disabled',
    'DISPID_SRCVoicePurgeEvent', 'SpeechVoiceSkipTypeSentence',
    'DISPID_SVRate', 'SpeechVoicePriority', 'SPCT_SUB_COMMAND',
    'DISPID_SOTCSetId', 'DISPID_SPIGetDisplayAttributes',
    'SPRST_INACTIVE_WITH_PURGE', 'SpeechCategoryRecognizers',
    'SPGS_ENABLED', 'SPPHRASERULE', 'SPEI_SR_AUDIO_LEVEL',
    'DISPID_SPEsItem', 'IInternetSecurityMgrSite',
    'SPXMLRESULTOPTIONS', 'SPAS_STOP', 'SVP_20', 'SP_VISEME_16',
    'DISPID_SRCEStartStream', 'ISpNotifyTranslator',
    'SPCT_SUB_DICTATION', 'SVSFVoiceMask', 'DISPID_SpeechAudioStatus',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SAFT44kHz16BitStereo',
    'SPGRAMMARSTATE', 'SPEI_VOICE_CHANGE', 'DISPID_SpeechPhraseRules',
    'SpeechAudioProperties', 'SpMMAudioIn',
    'DISPID_SPEActualConfidence', 'SPSModifier', 'SPPROPERTYINFO',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SpeechLexiconPronunciation',
    'DISPID_SRCEEnginePrivate', 'SPEI_TTS_AUDIO_LEVEL', 'SPCT_SLEEP',
    'DISPIDSPTSI_ActiveOffset', 'SVP_12', 'SPEI_HYPOTHESIS',
    'DISPID_SRRGetXMLResult', 'DISPID_SPEAudioStreamOffset',
    'DISPID_SRGetRecognizers', 'ISpRecognizer3',
    'SpeechCategoryAppLexicons', 'SAFT48kHz8BitMono',
    'DISPID_SGRInitialState', 'SpeechCategoryAudioOut',
    'DISPIDSPTSI_SelectionLength', 'DISPID_SAStatus', 'SLTApp',
    'ISpeechBaseStream', 'eLEXTYPE_RESERVED4', 'ISpVoice',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SPRDisplayAttributes',
    'DISPID_SDKDeleteKey', 'DISPID_SVSInputWordPosition',
    'ISpeechFileStream', 'ISpeechPhraseReplacements',
    'DISPID_SMSALineId', 'DISPID_SOTDisplayUI',
    'SpTextSelectionInformation', 'SPRECOCONTEXTSTATUS', 'SGDSActive',
    'SPVPRIORITY', 'DISPID_SASNonBlockingIO', 'DISPID_SPIGetText',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SWFESamplesPerSec',
    'SAFT24kHz16BitStereo', 'DISPID_SpeechGrammarRuleState',
    'SRERequestUI', 'DISPID_SPIElements', 'SPCONTEXTSTATE',
    'DISPID_SPILanguageId', 'SECFNoSpecialChars', 'SPEI_MIN_TTS',
    'DISPID_SOTSetId', 'DISPID_SPRuleFirstElement', 'SpeechRuleState',
    'SSSPTRelativeToEnd', 'SWPUnknownWordUnpronounceable',
    'SSTTWildcard', 'SVEVoiceChange', 'SpMMAudioOut',
    'SPFM_OPEN_READWRITE', 'DISPID_SVStatus', 'DISPID_SPCPhoneToId',
    'DISPID_SRCEPhraseStart', 'SVP_13', 'DISPID_SPPId',
    'SREInterference', 'SpInProcRecoContext',
    'ISpeechTextSelectionInformation',
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SpeechLexicon',
    'SP_VISEME_18', 'SGSExclusive', 'SPAUDIOOPTIONS',
    'eLEXTYPE_PRIVATE8', 'SWTDeleted', 'SPEI_FALSE_RECOGNITION',
    'SPPHRASEPROPERTY', 'ISpeechGrammarRuleStateTransitions',
    'SPWF_SRENGINE', 'DISPID_SOTCId', 'SVEStartInputStream',
    'SPPHRASE', 'DISPID_SGRsDynamic', 'SITooQuiet', 'ISpRecoGrammar2',
    'DISPID_SMSGetData', 'tagSPTEXTSELECTIONINFO', 'SVP_10',
    'SpeechCategoryAudioIn', 'DISPID_SDKSetStringValue',
    'SAFT8kHz8BitStereo', 'SPINTERFERENCE'
]
